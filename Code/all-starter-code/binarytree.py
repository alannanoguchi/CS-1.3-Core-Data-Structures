...
class BinaryTreeNode(object):
    ...
    def height(self):
        ...
        # set a variable count to 0 and increase count if on left or right side
...
class BinarySearchTree(object):
    ...
    def contains(self, item):
        ...
        TODO: Best case running time: ??? under what conditions? O(1) if it is the root node
        TODO: Worst case running time: ??? under what conditions? O(n) if the node that you are looking for is not there """
    ...
    def search(self, item):
        ...
        TODO: Best case running time: ??? under what conditions? O(1) if it is the root node
        TODO: Worst case running time: ??? under what conditions? O(n) if the node tht you are looking for is not there """
        # Find a node with the given item, if any
        node = self._find_node_recursive(item, self.root)
    ...
    def insert(self, item):
        ...
        if item < parent.data and parent.left is None:
            ...
            # also check that parent.data is none #
    ...
    def _find_node_iterative(self, item):
        ...
        TODO: Best case running time: ??? under what conditions? O(1) if it is the root node
        TODO: Worst case running time: ??? under what conditions? O(n) if the node is not there """
    ...
    def _find_node_recursive(self, item, node):
        ...
        TODO: Best case running time: ??? under what conditions? O(1) if the node is the root
        TODO: Worst case running time: ??? under what conditions? O(n) if the node is not there"""
    ...
    def _find_parent_node_recursive(self, item, node, parent=None):
        ...
        # TODO: Check if the given item is less than the node's data
            ...
            if node.left is None:  # note: doesn't need else statement because it returns something 
                return node
            # TODO: Recursively descend to the node's left child, if it exists
            return self._find_parent_node_recursive(item, node.left, node)  # Hint: Remember to update the parent parameter
        # TODO: Check if the given item is greater than the node's data
        elif item > node.data:
            # check to see if the node doesn't have any children
    ...
    def delete(self, item):
        ...
        # find node I want to delete, call helper find methods
        ...
        #     pass
        #     # find in order successor, helper method here
    ...
    def _traverse_post_order_recursive(self, node, visit):
        ...
        Start at the given node and visit each node with the given function.
        TODO: Running time: ??? Why and under what conditions? O(n) traverses every node
        TODO: Memory usage: ??? Why and under what conditions? O(n) depends on how tall the tree is"""
        # TODO: Traverse left subtree, if it exists
        if node.left:
